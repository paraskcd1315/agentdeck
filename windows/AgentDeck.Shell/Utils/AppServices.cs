using AgentDeck.Shell.Data.Config;
...
public static class AppServices
{
    ...
    private static readonly Lazy<AppConfig> ConfigInstance = new(AppConfigStore.Load);
    ...
    public static AppConfig Config => ConfigInstance.Value;
}
